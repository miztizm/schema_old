...
<template>
  <Popover>
    ...
    >
      ...
      <PopoverPanel
        class="absolute z-[9999] mt-6 w-screen"
        :class="[
      ...
      >
        <FocusTrap>
          <div
            class="border-slate-300 dark:border-primary-800 after:border-slate-300 dark:bg-primary-900 dark:after:border-primary-800 dark:after:bg-primary-900 shadow-muted-300/30 dark:shadow-muted-800/20 relative w-full rounded-lg border bg-white shadow-xl after:absolute after:-top-2 after:size-4 after:rotate-[-135deg] after:border-b after:border-r after:bg-white after:content-['']"
            :class="[
