...
const classes = computed(() => [
  ...
  sizes[size],          // Corrected from size.value
  radiuses[rounded],    // Corrected from rounded.value
  variants[variant],    // Corrected from variant.value
  colors[color],        // Corrected from color.value
