...
// Non-authenticated header links
const nonAuthHeaderLinks = [
/*   {
    label: 'Home',
    icon: 'i-ph-house',
    to: '/'
...
// Use computed to decide which header links to return
const headerLinks = computed(() =>
  isAuthenticated ? authHeaderLinks : nonAuthHeaderLinks
)
...
const mobileNav = computed(() =>
  isAuthenticated ? authMobileNav : nonAuthMobileNav
)
